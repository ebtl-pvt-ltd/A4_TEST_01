...
/* TOUCHKEYS bank(s) definition*/
   ...
   {&MyChannels_Src[8], &MyChannels_Dest[8], MyChannels_Data, BANK_6_NBCHANNELS, BANK_6_MSK_CHANNELS, BANK_6_MSK_GROUPS},
   {&MyChannels_Src[10], &MyChannels_Dest[10], MyChannels_Data, BANK_7_NBCHANNELS, BANK_7_MSK_CHANNELS, BANK_7_MSK_GROUPS},
   {&MyChannels_Src[11], &MyChannels_Dest[11], MyChannels_Data, BANK_8_NBCHANNELS, BANK_8_MSK_CHANNELS, BANK_8_MSK_GROUPS},
   {&MyChannels_Src[13], &MyChannels_Dest[13], MyChannels_Data, BANK_9_NBCHANNELS, BANK_9_MSK_CHANNELS, BANK_9_MSK_GROUPS},
   {&MyChannels_Src[14], &MyChannels_Dest[14], MyChannels_Data, BANK_10_NBCHANNELS, BANK_10_MSK_CHANNELS, BANK_10_MSK_GROUPS},
   {&MyChannels_Src[16], &MyChannels_Dest[16], MyChannels_Data, BANK_11_NBCHANNELS, BANK_11_MSK_CHANNELS, BANK_11_MSK_GROUPS},
   {&MyChannels_Src[17], &MyChannels_Dest[17], MyChannels_Data, BANK_12_NBCHANNELS, BANK_12_MSK_CHANNELS, BANK_12_MSK_GROUPS},
};
/*============================================================================*/
/* Touchkey sensors                                                           */
/*============================================================================*/
