...
static void MX_COMP6_Init(void)
{
  ...
  hcomp6.Init.InvertingInput = COMP_INVERTINGINPUT_VREFINT;
...
static void MX_TSC_Init(void)
{
  ...
  */
  ...
  htsc.Init.ChannelIOs = TSC_GROUP1_IO2|TSC_GROUP1_IO3|TSC_GROUP1_IO4|TSC_GROUP2_IO2
                    ...
                    |TSC_GROUP3_IO4|TSC_GROUP6_IO2|TSC_GROUP6_IO3|TSC_GROUP6_IO4
                    |TSC_GROUP7_IO2|TSC_GROUP7_IO3|TSC_GROUP7_IO4|TSC_GROUP8_IO2
                    |TSC_GROUP8_IO3|TSC_GROUP8_IO4;
  htsc.Init.ShieldIOs = TSC_GROUP5_IO2;
  htsc.Init.SamplingIOs = TSC_GROUP1_IO1|TSC_GROUP2_IO1|TSC_GROUP3_IO1|TSC_GROUP5_IO4
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, ESP_RST_Pin|RL_1_Pin|RL_2_Pin|RL_3_Pin 
                          |RL_4_Pin|RL_5_Pin|RL_6_Pin|RL_7_Pin 
                          |RL_8_Pin|RL_9_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SD_CS_GPIO_Port, SD_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, TFT_A0_Pin|TFT_RST_Pin|TFT_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ESP_RST_Pin RL_1_Pin RL_2_Pin RL_3_Pin 
                           RL_4_Pin RL_5_Pin RL_6_Pin RL_7_Pin 
                           RL_8_Pin RL_9_Pin */
  GPIO_InitStruct.Pin = ESP_RST_Pin|RL_1_Pin|RL_2_Pin|RL_3_Pin 
                          |RL_4_Pin|RL_5_Pin|RL_6_Pin|RL_7_Pin 
                          |RL_8_Pin|RL_9_Pin;
  ...
  /*Configure GPIO pins : TFT_A0_Pin TFT_RST_Pin TFT_CS_Pin */
  GPIO_InitStruct.Pin = TFT_A0_Pin|TFT_RST_Pin|TFT_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
